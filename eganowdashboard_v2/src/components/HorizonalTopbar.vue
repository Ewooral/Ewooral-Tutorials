                ...
                <ul class="list-unstyled topnav-menu float-right mb-0">
                    ...
                    <li class="dropdown d-none d-lg-inline-block">
                        <a
                                ...
                                @click="RequestMerchantService"
                                href="#"
                        >

<!--                           <u> {{ $t('dashboard.manage_merchant_service') }} </u>-->
                           <u> Request merchant account </u>
                        </a>
                    </li>
                ...
                <i class="mdi mdi-chevron-down"></i>
                        ...
                        <b-dropdown-divider></b-dropdown-divider>
                        <a class="dropdown-item" style="cursor: pointer" @click="VerifyEmailAndGetSecurityQuestion">
                            <i class="fe-edit mr-1"></i>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            RequestMerchantService(){
                try {
                    this.$router.push('merchantservice/merchant/merchantrequest').catch(() => { })
                    console.log( " Go to settings")
                }catch (e) {
                    console.log(" Error : ", e)
                }
